    ...
    <section id="about" className="flex-center relative md:p-0 px-5">
      ...
      <div className="container w-full h-full md:my-40 my-20 relative z-10">
        <TitleHeader
          title="About Me"
          number="01"
          text="Senior Application Manager · Platform Reliability · Cloud Modernization"
        />
          ...
          <div className="grid grid-cols-12 md:grid-rows-12 gap-5">
              ...
              <div className="bg-black-300 rounded-2xl p-7 w-full h-full">
                ...
                <div className="mt-5">
                  ...
                  <p className="md:text-2xl mt-2">
                    Senior Application Manager with 5+ years of leadership at Eurofins IT Delivery Center, Bengaluru. Expert in managing LIMS, scientific applications, and enterprise-grade platforms within regulated, high-availability environments. Passionate about cloud modernization, DevOps automation, and building resilient platform ecosystems aligned with long-term business goals.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-black-300 rounded-2xl p-7 w-full h-full">
                <div className="flex flex-col h-full justify-center gap-2">
                  ...
                  <p className="md:text-2xl max-w-96">
                    Azure infrastructure, CI/CD pipelines, IaC provisioning, and automated deployment orchestration at scale.
                  </p>
                </div>
              </div>
            </div>
            <div className="md:col-span-6 col-span-12 row-span-3">
              <div className="bg-black-300 rounded-2xl p-7 w-full h-full">
                <div className="flex flex-col h-full justify-center gap-2">
                  <h1 className="gradient-title md:text-3xl text-2xl font-medium">
                    Platform Reliability (SLO/SLI)
                  </h1>
                  <p className="md:text-2xl max-w-96">
                    24/7 global production operations with predictive monitoring, SLA compliance, and RCA/CAPA frameworks.
                  </p>
                </div>
              </div>
            </div>
